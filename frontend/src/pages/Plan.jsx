import { ArrowLeft, Check, Crown, Currency, Sparkles, Zap } from 'lucide-react';
...
const plans = [
    {
        key: "free",
        name: "Free",
        description: "For trying out the VertexAI IDE.",
        price: "₹0",
        period: "/month",
...
'>
                  ...
                  "
                                ...
                                <p className='mt-1 min-h-[40px] text-xs leading-5 text-slate-500 dark:text-slate-400'>{plan.description}</p>
